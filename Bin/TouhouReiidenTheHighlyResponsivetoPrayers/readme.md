# Touhou 01: Highly Responsive to Prayers (Linux Setup)
...
cd th99/Bin/TouhouReiidenTheHighlyResponsivetoPrayers
```
...
3. Выбери файл `TouhouReiidenTheHighlyResponsivetoPrayers.hdi`.
